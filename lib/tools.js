...
function battle(room_id){
	...
	var question = get_question(1, 1, room.answer_user_id);
...
function get_question(level, category, who_answer){
	// get it for redis
	//......

	var question = {
		q: 'man have how many eggs?',
		h: ['one', 'two', 'three', 'no one'],
		a: '2',
		c: 'biology',
		d: 9,
		ans: who_answer
